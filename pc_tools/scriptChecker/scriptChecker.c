...
/*
    ...
    fwrite(file, sizeof(char), fileSize, pFile);
    fclose(pFile);
*/
                    ...
                    case FUNCTION_LCDW:
                        if(argumentList[1].exist && argumentList[2].exist && argumentList[2].text != NULL && argumentList[2].type == ARGTYPE_STRING){
                            if(argumentList[3].exist && (argumentList[3].type == ARGTYPE_VARIABLE || argumentList[3].type == ARGTYPE_NUMERIC))
                                ...
                                lcdPrintFunction((unsigned char)argumentList[1].value, argumentList[2].text, 40);  //Use xLCD.LineSize for XBlast implementation
                        }
                        else{
...
bool lcdPrintFunction(unsigned char line, char * text, unsigned char stringLength){
    char tempString [41];
    unsigned char inputStringLength = strlen(text);
    ...
    printf("\n****LCD Print at line %u : %s", line, tempString);
                    ...
                    case FUNCTION_LCDW:
                        if(argumentList[1].exist && argumentList[2].exist && argumentList[2].text != NULL && argumentList[2].type == ARGTYPE_STRING){
                            if(argumentList[3].exist && (argumentList[3].type == ARGTYPE_VARIABLE || argumentList[3].type == ARGTYPE_NUMERIC))
                                ...
                                lcdPrintFunction((u8)argumentList[1].value, argumentList[2].text, 40);  //Use xLCD.LineSize for XBlast implementation
                        }
                        else{
                            printf("\nRuntime execution error. Improper LCDW function call!");
                        }
...
bool lcdPrintFunction(u8 line, char * text, u8 stringLength){
    char tempString [41];
    u8 inputStringLength = strlen(text);
