...
#define LcdSettingArraySize 2
    ...
    XBlastLogger(DBG_LVL_INFO, DEBUG_SETTINGS, "key:\"%s\"  value:\"%s\"", key, value);

    for(i = 0; i < BoolParamGroup; i++)
    {
        if(0 == strcasecmp(xblastCfgStringsStruct.boolSettingsStringArray[i], key))
        {
            XBlastLogger(DBG_LVL_DEBUG, DEBUG_SETTINGS, "found bool setting: %s", xblastCfgStringsStruct.boolSettingsStringArray[i]);
            if(*value >='0' && *value <='9')
            {
    ...
    for(i = 0; i < NumParamGroup; i++)
    {
        ...
        {
            XBlastLogger(DBG_LVL_DEBUG, DEBUG_SETTINGS, "found num setting: %s", xblastCfgStringsStruct.numSettingsStringArray[i]);
            if(*value >='0' && *value <='9')
            {
    ...
    for(i = 0; i < IPParamGroup; i++)
    {
        ...
        {
            XBlastLogger(DBG_LVL_DEBUG, DEBUG_SETTINGS, "found IP setting: %s", xblastCfgStringsStruct.IPsettingsStringArray[i]);
    ...
    for(i = 0; i < TextParamGroup; i++)
    {
        ...
        {
            XBlastLogger(DBG_LVL_DEBUG, DEBUG_SETTINGS, "found text setting: %s len:%u", xblastCfgStringsStruct.textSettingsStringArray[i]);
    ...
    for(i = 0; i < SpecialParamGroup; i++)
    {
      ...
      {
          XBlastLogger(DBG_LVL_DEBUG, DEBUG_SETTINGS, "found special setting: %s len:%u", xblastCfgStringsStruct.specialSettingsStringArray[i]);
          switch(i)
          {
...
int LPCMod_ReadCFGFromHDD(_LPCmodSettings *LPCmodSettingsPtr, _settingsPtrStruct *settingsStruct)
{
    ...
    if(isMounted(HDD_Master, Part_C))
    {
        ...
        {
            XBlastLogger(DBG_LVL_ERROR, DEBUG_SETTINGS, "ini_browse fail");
            return 4;
        }
    }
    else
...
int LPCMod_SaveCFGToHDD(_settingsPtrStruct *settingsStruct)
{
    ...
    for(i = 0; i < BoolParamGroup; i++)
    {
        XBlastLogger(DBG_LVL_DEBUG, DEBUG_SETTINGS, "%s=%u", xblastCfgStringsStruct.boolSettingsStringArray[i], *settingsStruct->boolSettingsPtrArray[i]);
        ...
        {
            XBlastLogger(DBG_LVL_ERROR, DEBUG_SETTINGS, "!!!Error on writing: %s=%u", xblastCfgStringsStruct.boolSettingsStringArray[i], *settingsStruct->boolSettingsPtrArray[i]);
            return 1;
        }
    }
    ...
    for(i = 0; i < NumParamGroup; i++)
    {
        XBlastLogger(DBG_LVL_DEBUG, DEBUG_SETTINGS, "%s=%u", xblastCfgStringsStruct.numSettingsStringArray[i], *settingsStruct->numSettingsPtrArray[i]);
        ...
        {
            XBlastLogger(DBG_LVL_ERROR, DEBUG_SETTINGS, "!!!Error on writing: %s=%u", xblastCfgStringsStruct.numSettingsStringArray[i], *settingsStruct->numSettingsPtrArray[i]);
            return 1;
        }
    }
    ...
    for(i = 0; i < IPParamGroup; i++)
    {
        ...
        XBlastLogger(DBG_LVL_DEBUG, DEBUG_SETTINGS, "%s=%s", xblastCfgStringsStruct.IPsettingsStringArray[i], tempStringBuf);
        if(0 == ini_puts(NULL, xblastCfgStringsStruct.IPsettingsStringArray[i], tempStringBuf, settingsFileLocation))
        {
            XBlastLogger(DBG_LVL_ERROR, DEBUG_SETTINGS, "!!!Error on writing: %s=%s", xblastCfgStringsStruct.IPsettingsStringArray[i], tempStringBuf);
            return 1;
        }
    }
    ...
    for(i = 0; i < TextParamGroup; i++)
    {
        XBlastLogger(DBG_LVL_DEBUG, DEBUG_SETTINGS, "%s=%s", xblastCfgStringsStruct.textSettingsStringArray[i], settingsStruct->textSettingsPtrArray[i]);
        ...
        {
            XBlastLogger(DBG_LVL_ERROR, DEBUG_SETTINGS, "!!!Error on writing: %s=%s", xblastCfgStringsStruct.textSettingsStringArray[i], settingsStruct->textSettingsPtrArray[i]);
            return 1;
        }
    }
    ...
    for(i = 0; i < SpecialParamGroup; i++)
    {
        XBlastLogger(DBG_LVL_DEBUG, DEBUG_SETTINGS, "%s=%s", xblastCfgStringsStruct.specialSettingsStringArray[i], getSpecialSettingTextString(i, *settingsStruct->specialCasePtrArray[i]));
        ...
        {
            XBlastLogger(DBG_LVL_ERROR, DEBUG_SETTINGS, "!!!Error on writing: %s=%s", xblastCfgStringsStruct.specialSettingsStringArray[i], getSpecialSettingTextString(i, *settingsStruct->specialCasePtrArray[i]));
            return 1;
        }
    }
